...
function createEmptyThreadUiState() {
  return {
    input: "",
    status: "idle",
    activityDetail: "",
...
function WorkspacePreviewPanel({ workspacePreview, onClose }) {
  if (!workspacePreview) {
    return null;
  }
  return (
...
function ChatMessageFeed({ renderItems }) {
...
function ApprovalStack({ approvalItems, approvalBusyId, onSubmitApproval }) {
...
function useThreadScopedState(activeThread) {

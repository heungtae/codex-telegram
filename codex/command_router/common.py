...
COMMAND_HELP: dict[str, str] = {
    ...
    "/guardian": "Show guardian summary. Edit guardian settings/rules in Web UI. Usage: /guardian",
    "/modes": "List collaboration modes. Usage: /modes",
    "/collab": "List collaboration modes. Usage: /collab",
    "/mode": "Show or set collaboration mode. Usage: /mode [toggle|plan|build]",
    "/plan": "Switch collaboration mode to plan. Usage: /plan",
    "/build": "Switch collaboration mode to build(default). Usage: /build",
